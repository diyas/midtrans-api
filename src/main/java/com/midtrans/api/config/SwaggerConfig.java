package com.midtrans.api.config;
...
//    Oauth2Properties properties;
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.midtrans.api.main"))
...
//
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Gopay Ewallet").description("")
